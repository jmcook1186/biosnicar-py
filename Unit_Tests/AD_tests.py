...
compare_spectra(tolerance = 0.1, solzen = 67,\
     path='/home/joe/Code/BioSNICAR_GO_PY/Unit_Tests/AD_LUTs/',\
          test = "CLEAN", plot_spectra = True)


# REFspectrum, REFwvl = generate_reference_spectrum()  

# def generate_reference_spectrum():
#     """

#     function returns wavlength and reference solid ice spectrum at
#     SNICAR resolution (10nm) between 0.35 - 2.5 um (wavelength range of
#     ASD Field Spec)

#     """

#     wvl = np.arange(0.35,2.5,0.001)
#     hcrf_file = '/home/joe/Code/BioSNICAR_GO_PY/Data/HCRF_master_16171819.csv'

#     # ground reflectance dataset
#     # Read in raw HCRF data to DataFrame.
#     hcrf_master = pd.read_csv(hcrf_file)

#     # Group site names according to surface class
#     SOLIDICEsites = ['WAT_1','WAT_2', 'WAT_3', 'WAT_4']
#     # ['21_7_SB8', '23_7_S5', '24_7_S2', '25_7_S2', '25_7_S2', '25_7_S3',
#     # '25_7_S4']
#     REFspectrum = hcrf_master[SOLIDICEsites].mean(axis=1)

#     # calculate correction factor (raises NIR to meet VIS - see Painter 2011)
#     corr = REFspectrum.loc[651] - REFspectrum.loc[650]
#     REFspectrum.loc[651:2149] = REFspectrum.loc[651:2149]-corr

#     # reduce to SNICAR spectral resolution
#     REFspectrum = REFspectrum[0::10].to_numpy()
#     REFwvl = wvl[0::10]
