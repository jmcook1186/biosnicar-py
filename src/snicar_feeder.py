...
def snicar_feeder(inputs):
    ...
    c_factor_SA = inputs.c_factor_SA
    c_factor_GA = inputs.c_factor_GA
    ...
    ssa_aer = np.zeros([nbr_aer, nbr_wvl])
    mac_aer = np.zeros([nbr_aer, nbr_wvl])
    g_aer = np.zeros([nbr_aer, nbr_wvl])
    mss_aer = np.zeros([nbr_lyr, nbr_aer])
