...
ds = xr.open_dataset('/home/joe/Code/BioSNICAR_GO_PY/Data/GO_files/dust_greenland_C_20150308.nc')
...
newDS = xr.Dataset(data_vars=dict(
...
newDS.to_netcdf('/home/joe/Code/BioSNICAR_GO_PY/Data/GO_files/480band/Cook_Greenland_Central.nc',mode='w')